...
### CHANGE: Disable the untrusted repository for future security
echo ">>> Disabling the gh0stzk-dotfiles repository for future updates..."
# This comments out the [gh0stzk-dotfiles] line and the 2 lines that follow it.
...
### CHANGE: Added a message to inform the user about the disabled repo.
